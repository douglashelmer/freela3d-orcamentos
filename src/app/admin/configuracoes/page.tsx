...
type GCalStatus = { connected: boolean }
  ...
  useEffect(() => {
    fetch('/api/usuario/perfil')
      ...
      .then(d => {
        ...
        setGcal({ connected: d.googleCalendarConnected ?? false })
        setLoading(false)
      })
  }, [])
          ...
          {gcal.connected ? (
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="px-4 py-2 rounded-xl text-xs font-medium text-red-400 hover:bg-red-400/10 transition-colors disabled:opacity-50"
              >
