      ...
      <div className="min-h-screen print-root" style={{ background: '#1E1E1E' }}>
        ...
        <main className="max-w-3xl mx-auto px-6 py-10 flex flex-col gap-8">
          ...
          {quote.sections.map(sec => (
            <div key={sec.id} className="rounded-2xl border p-6 print-card" style={{ background: '#252525', borderColor: '#333' }}>
          ...
          {quote.items.length > 0 && (
            <div className="rounded-2xl border overflow-hidden print-card" style={{ background: '#252525', borderColor: '#333' }}>
          ...
          {/* Signature Section */}
          {!isSigned && (
            <div className="rounded-2xl border p-6 no-print" style={{ background: '#252525', borderColor: '#333' }}>
          ...
          {isSigned && quote.signatureData && (
            <div className="rounded-2xl border p-6 print-card" style={{ background: '#252525', borderColor: '#333' }}>
